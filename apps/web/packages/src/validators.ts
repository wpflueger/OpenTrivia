...
export function validateMessageEnvelope(data: unknown): data is Message<unknown> {
...
export function validateRoomJoinPayload(data: unknown): data is RoomJoinPayload {
  if (typeof data !== 'object' || data === null) return false;
...
export function validateAnswerSubmitPayload(data: unknown): data is AnswerSubmitPayload {
  if (typeof data !== 'object' || data === null) return false;
...
export function validateQuestionShowPayload(data: unknown): data is QuestionShowPayload {
  if (typeof data !== 'object' || data === null) return false;
  ...
  if (!Array.isArray(payload.choices) || payload.choices.length < 2) return false;
